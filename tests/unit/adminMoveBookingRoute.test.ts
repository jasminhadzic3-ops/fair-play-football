...
describe("admin move booking route", () => {
  ...
  it.each([
    ...
    ["source_game_not_found", "Source game not found."],
    ["source_game_cancelled", "cancelled game"],
    ["source_game_archived", "archived games"],
    ["source_game_not_active", "active games"],
    ["source_game_missing_starts_at", "structured kickoff"],
    ["source_game_completed", "completed games"],
