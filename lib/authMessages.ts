export const AUTH_MESSAGES = {
  ...
  chooseAge: "Choose your age to continue.",
  chooseFavouritePosition: "Choose your favourite position to continue.",
  enterUsername: "Enter your display name to continue.",
