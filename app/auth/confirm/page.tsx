        ...
        <section className="w-full rounded-[2rem] border border-zinc-800 bg-zinc-950 p-5 shadow-[0_18px_60px_rgba(0,0,0,0.35)] sm:p-8">
          {state === "checking" ? (
            <div aria-live="polite">
              ...
              <h1 className="mt-3 text-3xl font-black tracking-tight text-white sm:text-4xl">Confirming your email</h1>
              <p className="mt-3 text-sm leading-6 text-zinc-400">Please wait while we finish setting up your account.</p>
            </div>
          ) : (
            <div>
              <p className="text-xs font-bold uppercase tracking-[0.35em] text-zinc-500">Fair Play Football</p>
              <h1 className="mt-3 text-3xl font-black tracking-tight text-white sm:text-4xl">We couldn&apos;t verify your email</h1>
              <p role="alert" className="mt-3 text-sm leading-6 text-zinc-300">
                This link may have expired or already been used. Send a new verification email to continue.
              </p>
              <Link
